...
// ***Create/add a student to 'students' collectionin 'first-project-complete' DB via POSTMAN->***

// Generate fake json data via chatgpt, use the model file to generate dummy json data(student)
// Create new Collection, rename collection (first-project-complete), add request, and rename the request meaningfully
// To insert a student object to 'students' collection in 'first-project-complete' database, Send POST request to http://localhost:3000/api/v1/students/create-student
